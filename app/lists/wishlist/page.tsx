    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      {wishlistGames.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No games in wishlist</h3>
          <p className="text-gray-600 mb-4">Start adding games to your wishlist to track what you want to play.</p>
          <Link
            href="/games"
