  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Reviewed Games</h1>
      ...
      {reviews.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-12 text-center">
          ...
          <p className="text-gray-600 mb-4">Start reviewing games to share your thoughts with the community.</p>
          <Link
            href="/games"
